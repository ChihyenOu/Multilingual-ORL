...
def batch_data_variable(batch, vocab):
    ...
    # bert
    # Modify: set the max length = 512
    bert_length_list = [len(sentence.list_bert_indice) if len(sentence.list_bert_indice) <= MAX_LEN else MAX_LEN for sentence in batch]
