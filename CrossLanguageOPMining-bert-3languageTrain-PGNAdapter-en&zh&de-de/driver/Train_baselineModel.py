...
if __name__ == '__main__':
    ...
    vocab = creat_vocab(config.source1_train_file, config.source2_train_file, config.target_train_file, config.min_occur_count) #modify
    ...
    source1_data = read_corpus(config.source1_train_file, bert_token, lang_dic) #ADD
    source2_data = read_corpus(config.source2_train_file, bert_token, lang_dic) #ADD
    target_data = read_corpus(config.target_train_file, bert_token, lang_dic) #ADD
    data = source1_data + source2_data + target_data #ADD
